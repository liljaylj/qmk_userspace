...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_preonic_1x2uC(
        ...
        MEHTAB,     KC_Q,       KC_W,       KC_E,       KC_R,       KC_T,       KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,       KC_BSLS,
    ...
    [SYMBOLS] = LAYOUT_preonic_1x2uC(
        ...
        KC_LCTL,    _______,    _______,    _______,    KC_CAPS,          _______,          KC_P0,      KC_PDOT,    _______,    _______,    KC_RCTL
    ),

    [MEDIA] = LAYOUT_preonic_1x2uC(
        ...
        _______,    _______,    _______,    KC_APP,     _______,          _______,          KC_MPRV,    KC_MNXT,    _______,    _______,    _______
    ),
    ...
    [SYSTEM] = LAYOUT_preonic_1x2uC(
        ...
        _______,    _______,    _______,    XXXXXXX,    XXXXXXX,          _______,          DM_PLY1,    DM_PLY2,    _______,    _______,    _______
    ),
