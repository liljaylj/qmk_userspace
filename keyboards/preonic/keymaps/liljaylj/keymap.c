...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_preonic_grid(
        LT(SYSTEM,KC_GRV),      KC_1,           KC_2,       KC_3,           KC_4,       KC_5,   KC_6,       KC_7,       KC_8,       KC_9,       KC_0,               LT(3,KC_BSPACE),
        MT(MOD_MEH,KC_TAB),     KC_Q,           KC_W,       KC_E,           KC_R,       KC_T,   KC_Y,       KC_U,       KC_I,       KC_O,       KC_P,               KC_BSLASH,
        MT(MOD_HYPR,KC_ESC),    KC_A,           KC_S,       KC_D,           KC_F,       KC_G,   KC_H,       KC_J,       KC_K,       KC_L,       LT(1,KC_SCLN),      LT(2,KC_QUOTE),
        KC_LSFT,                LCTL_T(KC_Z),   KC_X,       KC_C,           KC_V,       KC_B,   KC_N,       KC_M,       KC_COMM,    KC_DOT,     RCTL_T(KC_SLSH),    RSFT_T(KC_ENT),
        LCTL_T(KC_HOME),        KC_LGUI,        KC_LALT,    TT(SYMBOLS),    TT(MEDIA),  KC_SPC, KC_SPC,     KC_LBRC,    KC_RBRC,    KC_RALT,    KC_RGUI,            RCTL_T(KC_END)
    ),
