...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BARE] = LAYOUT_preonic_1x2uC(
        ...
        KC_LCTL,    KC_LGUI,    KC_LALT,    TTSYM,      TTMED,            KC_SPC,           KC_LBRC,    KC_RBRC,    KC_RALT,    KC_RGUI,    KC_RCTL
    ),
    ...
    [SYMBOLS] = LAYOUT_preonic_1x2uC(
        ...
        _______,    _______,    _______,    _______,    KC_CAPS,          _______,          KC_P0,      KC_PDOT,    _______,    _______,    _______
    ),
